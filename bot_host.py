...
# Это необходимо для безопасного размещения на хостинге (например, Render).
BOT_TOKEN = os.environ.get('BOT_TOKEN') # <-- ИЗМЕНЕНО
if not BOT_TOKEN:
...
class PartyView(discord.ui.View):
    ...
    def __init__(self, bot, map_info: str, initial_slots: Dict[str, Any], initiator: discord.Member, slot_names: list, message_id: int, comment: Optional[str] = None):
        ...
        self._add_role_buttons() # Добавляем кнопки бронирования
...
# =================================================================
# АРБИТРАЖ: КЛАССЫ ВЫБОРА КАРТ И РОЛЕЙ
# =================================================================
...
class RoleSelectView(discord.ui.View):
    ...
    def __init__(self, bot, map_id_string: str, initiator: discord.Member):
        ...
        # Кнопка add_comment_button добавляется автоматически декоратором @discord.ui.button
